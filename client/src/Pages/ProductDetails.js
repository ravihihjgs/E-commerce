    ...
    return (
        <Layout>
            <div className="d-flex flex-wrap m-4 ">
                <div className="card mx-4 "style={{ width: "22rem", height: "25rem", alignContent: "center",boxShadow: '3px 3px 3px black' }}>
                    <img   style={{
                                width: "20rem",
                                maxHeight: "23rem",
                                minHeight: "8rem",
                ...
                <div className="col-md-6 product-details-info mx-5">
